        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body open" id="acc0">
                <div class="accordion-inner">
                    ...
                    <div class="ev-detail"><span class="ev-icon">◈</span><span>{{ $akad['tempat'] ?? 'Pendopo Kediaman' }}, {{ $akad['alamat'] ?? '' }}</span></div>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-body" id="acc1">
                <div class="accordion-inner">
                    ...
                    <div class="ev-detail"><span class="ev-icon">◈</span><span>{{ $resepsi['tempat'] ?? 'Pendopo Kediaman' }}, {{ $resepsi['alamat'] ?? '' }}</span></div>
